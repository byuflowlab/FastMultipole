...
##### tree constructor
#####
function Tree(system; expansion_order=7, leaf_size=100, n_divisions=20, shrink_recenter=false, allocation_safety_factor=1.0, estimate_cost=false, read_cost_file=false, write_cost_file=false)
