...
# optargs, _ = fmm!(system; expansion_order, ε_abs, leaf_size_source=20, multipole_threshold=0.5, scalar_potential=false, tune=true)
...
optargs, _ = fmm!(system; expansion_order, ε_abs, leaf_size_source, multipole_threshold, scalar_potential=false, tune=false)
@time fmm!(system; expansion_order, ε_abs, leaf_size_source, multipole_threshold, scalar_potential=false, tune=false, optargs...)
@time fmm!(system; expansion_order, ε_abs, leaf_size_source, multipole_threshold, scalar_potential=false, tune=false, optargs...)
@profview fmm!(system; expansion_order, ε_abs, leaf_size_source, multipole_threshold, scalar_potential=false, tune=false)
