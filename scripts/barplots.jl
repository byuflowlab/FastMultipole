...
leaf_size = 100
t_source = @elapsed fmm.fmm!(sources; velocity_gradient=false, leaf_size, lamb_helmholtz=false, expansion_order, ε_tol)

t_vortex = @elapsed fmm.fmm!(vortons; velocity_gradient=false, leaf_size, lamb_helmholtz=true, expansion_order, ε_tol)

t_source_vortex = @elapsed fmm.fmm!(source_vortons; velocity_gradient=false, leaf_size, lamb_helmholtz=true, expansion_order, ε_tol)
...
for i = 1:n_tests
    system1_times[i] += @elapsed fmm.fmm!((system1, system2, system3, system4, system5, system6), system1; velocity_gradient=false, leaf_size_target, leaf_size_source, lamb_helmholtz=false, expansion_order, ε_tol=1e-4)
end

println("starting tests 2")
for i in 1:n_tests
    system2_times[i] += @elapsed fmm.fmm!((system1, system2, system3, system4, system5, system6), system2; velocity_gradient=false, leaf_size_target, leaf_size_source, lamb_helmholtz=false, expansion_order, ε_tol=1e-4)
end

println("starting tests 3")
for i in 1:n_tests
    system3_times[i] += @elapsed fmm.fmm!((system1, system2, system3, system4, system5, system6), system3; velocity_gradient=false, leaf_size_target, leaf_size_source, lamb_helmholtz=false, expansion_order, ε_tol=1e-4)
end
...
for i in 1:n_tests
    system4_times[i] += @elapsed fmm.fmm!((system1, system2, system3, system4, system5, system6), system4; velocity_gradient=false, leaf_size_target, leaf_size_source, lamb_helmholtz=true, expansion_order, ε_tol=1e-4)
end
...
# leaf_size_source = 18
for i in 1:n_tests
    system5_times[i] += @elapsed fmm.fmm!((system1, system2, system3, system4, system5, system6), system5; velocity_gradient=false, leaf_size_target, leaf_size_source, lamb_helmholtz=true, expansion_order, ε_tol=1e-4)
end

println("starting tests 6")
for i in 1:n_tests
    system6_times[i] += @elapsed fmm.fmm!((system1, system2, system3, system4, system5, system6), system6; velocity_gradient=false, leaf_size_target, leaf_size_source, lamb_helmholtz=true, expansion_order, ε_tol=1e-4)
end
...
for i in 1:n_tests
    scalar_times[i] += @elapsed fmm.fmm!((system1, system2, system3, system4, system5, system6), (system1, system2, system3, system4); velocity_gradient=false, leaf_size_target, leaf_size_source, lamb_helmholtz=false, expansion_order, ε_tol=1e-4)
end
...
for i in 1:n_tests
    vector_times[i] += @elapsed fmm.fmm!((system1, system2, system3, system4, system5, system6), (system5, system6); velocity_gradient=false, leaf_size_target, leaf_size_source, lamb_helmholtz=true, expansion_order, ε_tol=1e-4)
end
...
for i in 1:n_tests
    combined_times[i] += @elapsed fmm.fmm!((system1, system2, system3, system4, system5, system6); velocity_gradient=false, leaf_size, lamb_helmholtz=true, expansion_order, ε_tol=1e-4)
end
