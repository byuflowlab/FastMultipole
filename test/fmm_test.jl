...
tree, m2l_list, direct_list, derivatives_switches = FastMultipole.fmm!(system3; expansion_order, leaf_size, multipole_threshold, nearfield=true, farfield=true, unsort_bodies=true)
